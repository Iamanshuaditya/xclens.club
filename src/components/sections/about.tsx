...
const AboutSection = () => {
  return (
    <section
      className="framer-619jvl relative bg-[#f3f3f3] py-[60px] md:py-[80px] overflow-hidden"
    ...
    >
      ...
      <div className="container relative z-10">
        <div className="max-w-[1200px] mx-auto">
          ...
          {/* Video Embed */}
          <div className="relative w-full aspect-video rounded-[12px] overflow-hidden mb-[40px] shadow-sm">
            <iframe
