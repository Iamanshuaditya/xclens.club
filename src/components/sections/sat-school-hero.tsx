...
/**
 * Book data — order matches the Framer Arms (0→315° in 45° steps).
 * Each arm's angle: 0, 45, 90, 135, 179, 225, 270, 315
 * color = dominant spine / back / hue-overlay color from original CSS.
 */
const booksData = [
...
/**
 * 3D Book — pixel-perfect match of the Framer "Book" component.
 *
 * Structure: Cover (front face, +22px Z), Back (rear face, -22px Z),
 * Right (page edges, rotateY -90), Spine (left edge, rotateY -90),
 * Top (page edge, rotateX -90), Bottom (page edge, rotateX -90),
 * Color (hue overlay, mix-blend-mode: hue).
 */
...
/**
 * SatSchoolHero — Ferris-wheel book carousel, pixel-perfect Framer match.
 *
 * Original layout:
 *   BOOKS (perspective 1400px, absolute over hero)
 *     └ Arm Wrap (rotate 47deg rotateX 29deg rotateY -70deg) — 3D tilt
 *         └ ARMS (100px wide, 100% tall of 2002px container, spins 360° in 50s linear)
 *             └ Arm × 8 (450px wide, 1px tall, rotated 0/45/90/135/179/225/270/315)
 *                 └ Book Holder (30% height at end of arm)
 *                     └ Book (rotate 45deg rotateX -40deg rotateY -5deg)
 *   Overlay (mask: linear-gradient 135deg, transparent 54%, black 71%)
 */
const SatSchoolHero = () => {
  ...
  return (
    <section className="relative w-full bg-black overflow-hidden" style={{ minHeight: '100vh' }}>
      ...
      <div className="absolute inset-0 z-20 pointer-events-none">
        <div className="max-w-[1400px] mx-auto px-8 md:px-12 lg:px-20 h-full flex items-center">
          <div className="max-w-[480px] pointer-events-auto">
            <h1
              className="text-white leading-[1.1] font-normal tracking-[-0.03em] mb-4"
              style={{
            ...
            <p className="text-white text-lg font-medium leading-[1.3] mb-6" style={{ fontFamily: '"Instrument Sans", sans-serif' }}>
              *Intellectually
            </p>

            <p className="text-white text-lg font-medium leading-[1.3] mb-8" style={{ fontFamily: '"Instrument Sans", sans-serif' }}>
      ...
      >
        {/* Arm Wrap — the 3D tilt container */}
        <div
          className="arm-wrap"
          style={{
            position: 'absolute',
          ...
          >
            ...
            {booksData.map((book, i) => {
              ...
              return (
                ...
                >
                  {/* Book Holder — positioned at 30% height from the arm end */}
                  <div
                    style={{
                      width: '100%',
                      height: '30%',
                  ...
                  >
                    {/* Book — counter-rotated for 3D presentation */}
                    <div
                      style={{
                        aspectRatio: `${book.w / book.h}`,
                        ...
                        alignItems: 'center',
                        justifyContent: 'center',
                        transform: 'rotate(45deg) rotateX(-40deg) rotateY(-5deg)',
                        overflow: 'visible',
                      }}
                    >
...
{/* Overlay mask removed */}
      ...
      <style jsx global>{`
        :root {
          --framer-aspect-ratio-supported: initial;
        }
