    ...
    <div className="flex flex-col w-full">
      ...
      <footer className="w-full bg-black text-white pt-24 pb-12 px-6 md:px-12 flex flex-col">
        <div className="max-w-[1200px] mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-0 items-start">
          ...
          {/* Navigation Links */}
          <div className="flex flex-row flex-wrap md:justify-end gap-x-8 gap-y-4">
            <a href="/" className="font-display text-[24px] md:text-[28px] hover:text-white/70 transition-colors">Home</a>
            <a href="/about" className="font-display text-[24px] md:text-[28px] hover:text-white/70 transition-colors">About</a>
            <a href="/blog" className="font-display text-[24px] md:text-[28px] hover:text-white/70 transition-colors">Blog</a>
            <a href="/contact" className="font-display text-[24px] md:text-[28px] hover:text-white/70 transition-colors">Contact</a>
          </div>
        </div>
